...
public class Application implements Closeable {
    ...
    private static final String AVAILABLE_COMMANDS_HELP_LIST;
    ...
    static {
        ...
        AVAILABLE_COMMANDS_HELP_LIST = Arrays.stream(Command.values())
   ...
   private void printCommandParametersMismatchMessage() {
    ...
    private Pair<Command, String[]> parseCommandLine(String line) {
        ...
        // suitable alias was not found, null is to be returned
        return null;
    }
    ...
    private void showInfo() {
        ...
        writer.writeLine(AVAILABLE_COMMANDS_HELP_LIST);
        writer.writeLine("");
    }
    ...
    public void close() throws IOException {
        ...
        for(Closeable resource : Arrays.asList(reader, writer)) {
            try {
                resource.close();
    ...
    private void printTooManyWordsRequestedMessage() {
        outputAnswer("The quantity of words you requested is too big for current dictionary");
    }
